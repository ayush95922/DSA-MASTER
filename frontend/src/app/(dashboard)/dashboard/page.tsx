    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Skeleton className="h-[120px] w-full rounded-2xl bg-muted/60" />
          <Skeleton className="h-[120px] w-full rounded-2xl bg-muted/60" />
          <Skeleton className="h-[120px] w-full rounded-2xl bg-muted/60" />
        </div>
        {/* Heatmap card skeleton */}
        <Skeleton className="h-[200px] w-full rounded-2xl bg-muted/60" />
        {/* Recommendations skeleton */}
        <Skeleton className="h-[250px] w-full rounded-2xl bg-muted/60" />
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
        ...
        <h3 className="text-xl font-bold text-foreground">Failed to load dashboard metrics</h3>
