  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-background text-foreground antialiased">
        ...
        <div className="flex h-16 items-center justify-between px-6 border-b border-border shrink-0">
          ...
          {isOpen && (
            <Button
              ...
              size="icon"
              onClick={toggle}
              className="h-8 w-8 text-muted-foreground hover:text-foreground hover:bg-accent md:flex hidden"
            >
              <ChevronLeft size={16} />
            </Button>
          )}
        ...
        <div className="border-t border-border p-4 shrink-0 space-y-2">
          <div className="flex items-center gap-3">
            <Avatar className="h-9 w-9 border border-border">
              ...
              <AvatarFallback className="bg-muted text-emerald-600 dark:text-emerald-400 font-bold">
                {userInitials}
              </AvatarFallback>
            </Avatar>
            {isOpen && (
          ...
          {isOpen && (
            <Button
              variant="ghost"
              onClick={logout}
              className="w-full justify-start text-muted-foreground hover:text-destructive hover:bg-destructive/10 font-bold mt-2"
            >
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* Header bar */}
        <header className="flex h-16 items-center justify-between border-b border-border bg-background/40 backdrop-blur-md px-6 shrink-0">
          {/* Header left */}
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-bold tracking-tight text-foreground capitalize hidden sm:block">
