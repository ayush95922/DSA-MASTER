      ...
      <CardContent className="space-y-5 py-2">
        ...
        <div>
          <div className="text-4xl font-extrabold text-white flex items-baseline gap-1">
            {totalSolved}
            <span className="text-sm font-semibold text-zinc-500">solved</span>
          </div>
          <p className="text-xs text-zinc-400 mt-1">Total unique coding accomplishments</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="flex justify-between text-xs font-semibold mb-1">
              ...
              <span className="text-zinc-300">{easySolved} / {easyTarget}</span>
            </div>
          ...
          <div>
            <div className="flex justify-between text-xs font-semibold mb-1">
              ...
              <span className="text-zinc-300">{mediumSolved} / {mediumTarget}</span>
            </div>
            <div className="h-1.5 w-full bg-zinc-900 rounded-full overflow-hidden">
              <div
          ...
          <div>
            <div className="flex justify-between text-xs font-semibold mb-1">
              ...
              <span className="text-zinc-300">{hardSolved} / {hardTarget}</span>
            </div>
            <div className="h-1.5 w-full bg-zinc-900 rounded-full overflow-hidden">
              <div
